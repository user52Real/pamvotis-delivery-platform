...
class _AllBlockedRidersScreenState extends State<AllBlockedRidersScreen> {
  ...
  displayDialogBoxForActivating(userDocumentID){
    return showDialog(
        context: context,
  ...
  Widget build(BuildContext context) {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      onPressed: (){
                        displayDialogBoxForActivating(allRiders!.docs[i].id);
                      },
                    ),
                  ),
                ],
    ...
    return Scaffold(
      appBar: SimpleAppBar(title: "All Blocked Riders",),
      body: Center(
        child: Container(
